          ...
          <div class="box-body">
            <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="kota" id="exampleInputtext1" placeholder=""  value="<?= $data_user['kota']?>" >
                  <div class="warna"><?php echo form_error('kota');?></div>
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Provinsi</label>
                  <input type="text" class="form-control" name="provinsi" id="exampleInputtext1 required="" value="<?= $data_user['provinsi']?>"  >
                  <div class="warna"><?php echo form_error('provinsi');?></div>
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Kode POS</label>
                  <input type="number" class="form-control" name="kodepos" id="exampleInputtext1" placeholder="" value="<?= $data_user['kode_pos']?>" >
                  <div class="warna"><?php echo form_error('kodepos');?></div>
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Telepon</label>
                  <input type="number" class="form-control" name="telepon" id="exampleInputtext1" placeholder="" value="<?= $data_user['telepon']?>" >
