				...
				<?php foreach ($user as $rows) { ?>
					...
					<tr>
						...
						<td>
							...
							<a onClick="javascript: return confirm('Are you sure to Delete Data');" href="<?php echo base_url(); ?>user/datahapus/<?php echo $rows['username'] ?>" class="btn btn-danger btn-xs" title="Delete" onclick="return confirm('apakah anda yakin data ingin dihapus ?') "><i class="fa fa-trash"></i></a>
