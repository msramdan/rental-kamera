...
<body class="hold-transition login-page">
	<div class="login-box">
		<div class="login-logo">
			<img style="width: 90%;height: auto;margin-bottom: 10px; margin-top: -40px;margin-left:-15px;" src="<?php echo base_url(); ?>assets/admin/images/logo.png">
			<!-- <a href=""><b>Camera</b> Rental</a> -->
		</div>
